...
\glsxtrnewsymbol[description={Stabilizer, element of $\m{S}$}]{zstabilizer}{\ensuremath{S}}
\glsxtrnewsymbol[description={Stabilizer generator, generates $\m{S}$}]{zstabilizergenerator}{\ensuremath{s}}
...
\glsxtrnewsymbol[description={Vertex set}]{svertices}{\ensuremath{V}}
\glsxtrnewsymbol[description={vertex, elemet of $V$}]{nvertex}{\ensuremath{v}}
\glsxtrnewsymbol[description={Edge set}]{sedges}{\ensuremath{E}}
\glsxtrnewsymbol[description={edge, element of $E$}]{nedge}{\ensuremath{e}}
\glsxtrnewsymbol[description={Face set}]{sfaces}{\ensuremath{F}}
\glsxtrnewsymbol[description={Face, element of $F$}]{nface}{\ensuremath{f}}
\glsxtrnewsymbol[description={Probability of error correction}]{zpcorrect}{\ensuremath{p_C}}
...
\glsxtrnewsymbol[description={Forest of erasure $\m{R}$}]{sforest}{\ensuremath{\m{F}_\m{R}}}
