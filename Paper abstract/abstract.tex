...
\begin{figure}[h]
  \centering
     ...
     \begin{minipage}[b]{0.3\textwidth}
         ...
         \end{tikzpicture}
         \captionof{figure}{2 DFS's on $\mathcal{N}$ to compute node parities and delays. The parities are calculated head recursively and delays tail recursively.}\label{fig3}
     \end{minipage}
\end{figure}
