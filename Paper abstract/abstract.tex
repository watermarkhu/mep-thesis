  ...
  \centering
     \begin{minipage}[b]{0.3\textwidth}
         ...
         \begin{tikzpicture}[scale=0.6]
           ...
           \node[node, draw=green, dotted] at (0,2) (2) {$v_0'$};
         ...
         \end{tikzpicture}
         \captionof{figure}{Unbalanced matching weight in cluster vertex set $\mathcal{V}$.}\label{fig1}
     \end{minipage}
     \hfill
     \begin{minipage}[b]{0.3\textwidth}
         \centering
         ...
         \end{tikzpicture}
         \captionof{figure}{A node set $\mathcal{N}$ vs. a vertex set $\mathcal{V}$, both representing the cluster.}\label{fig2}
     \end{minipage}
     \hfill
     \begin{minipage}[b]{0.3\textwidth}
         \centering
         ...
         \end{tikzpicture}
         \captionof{figure}{2 DFS's on $\mathcal{N}$ are needed to compute node parities and delays.}\label{fig3}
     \end{minipage}
\end{figure}
