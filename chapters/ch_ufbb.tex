...
\begin{figure}
  ...
  \vspace{1em}
   \begin{tikzpicture}
    ...
    \node[node, draw=mgreen, fill=mgreen, fill opacity=.2, text opacity=1, dashed] at (0,2) (2) {$v_o$};
    \node[node] at (2,0) (3){$v_2$};
    \node[node, draw=mblue, fill=mblue, fill opacity=.2, text opacity=1,dotted] at (2,2) (4) {$v_o$};
    \node[node] at (4,0) (5) {$v_3$};
    \node[node, draw=mred, fill=mred, fill opacity=.2, text opacity=1,dashdotted] at (4,2) (6) {$v_o$};

    \draw[l1, dashed, mgreen] (1) -- (2);
    \draw[l1, dashed, mgreen, transform canvas={yshift=3pt}] (3) -- (5);
    \draw[l1, dotted, mblue] (3) -- (4);
    \draw[l1, dotted, mblue, transform canvas={yshift=-3pt}] (1) -- (3) -- (5);
    \draw[l1, dashdotted, mred] (5) -- (6);
    \draw[l1, dashdotted, mred, transform canvas={yshift=3pt}] (3) -- (1);

  \end{tikzpicture}
  \caption{Unequal matching weight in cluster vertex set $\mathcal{V}$. The matching edges (dashed) correspond to the position of $v_o$. If $v_o$ is connected to $v_1$ or $v_3$, the resulting matchings have a weight of 2. IF $v_o$ is connected to $v_2$, the resulting matching has a weight of 3.}\label{fig:PMW}
\end{figure}
...
\begin{figure}
 ...
 \begin{tikzpicture}
   ...
   \path[pattern=dots, pattern color=mgreen] (0,3) arc (90:225:1) arc (45:-135:.4142) arc (45:315:1) arc (135:-45:.4142) arc (135:405:1) arc (225:135:.4142) arc (-45:45:1) arc (225:135:.4142) arc (-45:90:1) -- cycle;
   \path[pattern=grid , pattern color=mblue] (2,1) arc (90:450:1);
   \node[node, fill=white!70!mgreen] at (0,0) (0) {$v_1$};
   \node[node, fill=white!70!mblue] at (2,0) (1) {$v_2$};
   ...
   \node[node, pattern=dots, pattern color=mgreen] at (7,0) (d) {$\sigma_1$};
   \node[node, pattern=grid , pattern color=mblue] at (9,0) (e) {$\sigma_2$};
...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \path[pattern=horizontal lines, pattern color=mgreen, rounded corners=10pt, rotate around={45:(0)}] (-1,-1) rectangle (1,1);
    \path[pattern=vertical lines, pattern color=mblue, rounded corners=10pt, rotate around={45:(1)}] (1,-1) rectangle (3,1);
    \path[pattern=horizontal lines, pattern color=mred, rounded corners=10pt, rotate around={45:(2)}] (3,-1) rectangle (5,1);

    \node[nodel, fill=white!70!mgreen] at (0) (v0) {\footnotesize$v_1$};
    \node[nodel] at (-1,0) (v0l) {};
    \node[nodel] at (0,1) (v0u) {};
    \node[nodel] at (0,-1) (v0d) {};

    \node[nodel, fill=white!70!mblue] at (1) (v1) {\footnotesize$v_2$};
    \node[nodel] at (1,0) (v1l) {\footnotesize$v_{12}$};
    \node[nodel] at (2,1) (v1u) {};
    \node[nodel] at (2,-1) (v1d) {};

    \node[nodel, fill=white!70!mred] at (2) (v2) {\footnotesize$v_3$};
    ...
    \node at (7,1) {$\nset_e'$};
    \node[nodel, pattern=horizontal lines, pattern color=mgreen!25!white] at (7,0) (n0) {\footnotesize$\sigma_1$};
    \node[nodel, pattern=grid, pattern color=teal!25!white, diamond] at (8,0) (j01) {\footnotesize$j_{12}$};
    \node[nodel, pattern=vertical lines, pattern color=mblue] at (9,0) (n1) {\footnotesize$\sigma_2$};
    \node[nodel, pattern=grid, pattern color=violet!25!white, diamond] at (10,0) (j12) {\footnotesize$j_{23}$};
    \node[nodel, pattern=horizontal lines, pattern color=mred!25!white] at (11,0) (n2) {\footnotesize$\sigma_3$};
