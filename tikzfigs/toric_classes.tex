...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
      ...
      \end{pgfonlayer}
      \node[below=.25cm of Bx-2] {\emph{(a)}};
      \node[script] at (P-1-2) {\emph{(i)}};
      \node[script] at (P-1-4) {\emph{(ii)}};
      \node[script] at (P-3-1) {\emph{(iii)}};
      \node[script] at (P-1-0) {\emph{(iv)}};
