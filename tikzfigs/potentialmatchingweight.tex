\begin{figure}
  ...
  \end{tikzpicture}
  \caption{Unequal matching weight in cluster vertex-tree $\vset_e$. The matching edges (dashed) correspond to the position of $v_o$. If $v_o$ is connected to $v_1$ or $v_3$, the resulting matching has a weight of 2. If $v_o$ is connected to $v_2$, the resulting matching has a weight of 3.}\label{fig:PMW}
\end{figure}
