\begin{figure}[htbp]
  ...
  \end{tikzpicture}
  \caption{A visual represents of a $3\times 3$ toric code, which has periodic boundary conditions. The edges on the lattice, which represent the qubits, make up faces and vertices. The dual lattice is represented by the dotted lines. This figure is inspired by others \cite{browne}.}\label{sf:fig_toriclattice}
\end{figure}