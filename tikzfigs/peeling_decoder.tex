...
\begin{figure}
  ...
  \begin{tikzpicture}[on grid, scale=0.8]
    ...
    \begin{scope}[shift={(6,-12)}]
      ...
      \node[description={center}] at (2, -.5) {apply correction $C$};
    \end{scope}
