\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=1.2]
      ...
      \node[tnode, fill=white!70!mblue] at (0) (v0) {\small$v_1$};
      \node[tnode] at (-1,0) (v0l) {};
      \node[tnode] at (0,1) (v0u) {};
      \node[tnode] at (0,-1) (v0d) {};
  
      \node[tnode, fill=white!70!morange] at (1) (v1) {\small$v_2$};
      \node[tnode] at (1,0) (v1l) {\small$v_{12}$};
      \node[tnode] at (2,1) (v1u) {};
      \node[tnode] at (2,-1) (v1d) {};
  
      \node[tnode, fill=white!70!mgreen] at (2) (v2) {\small$v_3$};
      \node[tnode] at (3,0) (v2l) {\small$v_{23}$};
