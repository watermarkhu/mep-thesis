...
\begin{algorithm}[htb]
  ...
  \codefunc{Place} odd-parity clusters in $\m{L}_b$ (Al. \ref{algo:place})\;
  ...
  \BlankLine
  \caption{Union-Find Bucket Weighted Growth decoder}\label{algo:ufbwg}
\end{algorithm}
...
\begin{algorithm}[htb]
    ...
    \BlankLine
    \caption{Union-Find Dynamic Forest decoder}\label{algo:ufdf}
  \end{algorithm}
